...
function stage8_4_penalty ()
    ...
    if data.levelHi == 7 and data.levelLo == 3 then
        ...
        if (data.xscrollHi == 2 or data.xscrollHi == 3) and (data.yposHi == 1 and data.yposLo == 144) and data.state == 3 then
            local reward = -12.5
            data.state = 6
       ...
       -- don't loop, die
        elseif (data.xscrollHi == 0 or data.xscrollHi == 1) and (data.xpos >= 90 and data.xpos < 130) and (data.yposHi == 1 and data.yposLo <= 128) and data.enemy_present == 0 and data.state == 8 then
            local reward = -12.5
            data.state = 6
            if debug then print('stage8_4_penalty: ', reward) end
            return reward
        ...
        ------- section 2 -------
        -- don't go in second pipe
        elseif (data.xscrollHi == 7 or data.xscrollHi == 8) and (data.yposHi == 1 and data.yposLo == 144) and data.state == 3 then
            local reward = -12.5
            data.state = 6
            if debug then print('stage8_4_penalty: ', reward) end
            return reward
        ...
        ------- section 3 -------
        -- don't go in second pipe
        elseif (data.xscrollHi == 12 or data.xscrollHi == 13) and (data.yposHi == 1 and data.yposLo == 80) and data.state == 3 then
            local reward = -12.5
            data.state = 6
            if debug then print('stage8_4_penalty: ', reward) end
            return reward
       ...
       -- don't loop, die
        ...
        elseif data.xscrollHi == 16 and (data.yposHi == 1 and data.yposLo == 144) and data.state == 3 then
            local reward = -12.5
            data.state = 6
            if debug then print('stage8_4_penalty: ', reward) end
            return reward
...
function sum_reward ()
    return xscrollLo_reward() + levelLo_reward() + levelHi_reward() + dying_penalty() + lives_tracker() + progress_tracker() + checkpoint_tracker() + stage4_4_penalty() + stage7_4_penalty() + stage8_4_penalty()
end
