...
function sum_reward ()
    return xscrollLo_reward() + levelLo_reward() + levelHi_reward() + pipe_reward() + dying_penalty() + lives_tracker() + xscrollHi_tracker() + stage4_4_penalty() + stage7_4_penalty() + checkpoint_penalty()
end


function any_done ()
    return lives_done() or stage_done()
end
