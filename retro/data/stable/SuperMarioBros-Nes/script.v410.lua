...
function stage4_4_penalty ()
    -- custom reward function for loop detection on stage 4-4
...
function stage7_4_penalty ()
    -- custom reward function for loop detection on stage 7-4
    -- need to add -5 from timeout to penalty specified below
...
function progress_tracker ()
    if data.progress > previous_progress or data.progress == 24 or data.progress == 8 then
        previous_progress = data.progress
        is_looped = false
